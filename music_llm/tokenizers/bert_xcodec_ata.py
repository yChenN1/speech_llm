...
class BertXCodec2ATATokenizer:
    def __init__(self, vocab_size: int) -> None:
        ...
        new_vocabs = ["<boau>", "<eoau>", "<boag>", "<eoag>"]  # <boau>: begin of audio understanding; <eoau>: end of audio understanding; <boag>: begin of audio generation; <eoag>: end of audio generation
    ...
    @property
    def boau_token_id(self):
        return self.tok.convert_tokens_to_ids("<boau>")

    @property
    def eoau_token_id(self):
        return self.tok.convert_tokens_to_ids("<eoau>")

    @property
    def boag_token_id(self):
        return self.tok.convert_tokens_to_ids("<boag>")

    @property
    def eoag_token_id(self):
        return self.tok.convert_tokens_to_ids("<eoag>")
